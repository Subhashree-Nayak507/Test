        ...
        <div className="w-full max-w-md space-y-8 bg-white p-8 shadow-lg rounded-lg border border-gray-200">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn btn-primary w-full flex justify-center items-center py-3 rounded-lg font-semibold shadow-md text-white bg-blue-500 hover:bg-blue-600 focus:outline-none active:scale-95 disabled:opacity-70"
            >
              {isLoading ? (
